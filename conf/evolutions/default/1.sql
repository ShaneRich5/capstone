...
alter table assignments add constraint fk_assignments_course_2 foreign key (course_code) references courses (code) on delete restrict on update restrict;
create index ix_assignments_course_2 on assignments (course_code);
...
alter table submissions add constraint fk_submissions_course_4 foreign key (course_code) references courses (code) on delete restrict on update restrict;
create index ix_submissions_course_4 on submissions (course_code);
